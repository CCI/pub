...
would need to provide the semantics that are common to most vendor interfaces.

\subsection{Simplicity}
Simple: Socket is the reference.

\subsection{Performance}
Performance: Async operation (buffered or not), support for zero-copy, support for
