...
A single function $cci\_send()$ is used to send messages, its prototype is presented below. Two segments are supported by default to simplify data encapsulation behind an application header. The context is returned as part of a send completion event, if requested.
