...
SHMEM~\cite{shmem} API. With strong order between RDMA operations on a given 
QP, Verbs cannot easily leverage these bonding and adaptive routing to increase 
effective bandwidth.
